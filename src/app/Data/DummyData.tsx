...
export const comparisonData = [
  {
    feature: "Price Tag",
    medence: "Starting at ₹199",
    other: "Expensive",
  },
  {
    feature: "Price Clarity",
    medence: "Standard Pricing",
    other: "Uncertain & Hidden Pricing",
  },
  {
    feature: "Quality",
    medence: "Avg. 19 Years of Experience",
    other: "Unsure of Quality",
  },
  {
    feature: "Ease",
    medence: "Auto Case Updates",
    other: "Hassles & Runarounds",
  },
  {
    feature: "Flexibility",
    medence: "Lawyer Replacement Option",
    other: "No Flexibility",
  },
];
...
export const testimonials = [
  ...
  },
  {
    ...
    image: { two },
    rating: 5,
    review: `My flatmate came across medence over his social media about their free rental agreement checker. We were already in trouble by then though... Medence gave us an easy way out here with their flexible plans. Made us feel it was fair.`,
  },
  {
    name: "Pradeep Kumar",
    ...
    image: { three },
    rating: 5,
    review: `The customer team is highly responsive. While the lawyer himself was very professional from the start, what impressed me truly was their customer support. They responsed to my concerns and made me calm whenever I felt anxious with my legal issue.`,
  },
  {
    name: "G.Sneha",
    ...
    image: { four },
    rating: 5,
    review: `I was so tired with other divorce lawyers and their money extracting business. Medence's simple pricing is such a relief here. My trust with my Medence personal lawyer is especially so warm.`,
  },
  {
    name: "Ngvuyhum Semp",
    ...
    image: { five },
    rating: 5,
    review: `There was a freeze on my IDFC bank account. The fees charged by other lawyers was more than my savings that were frozen... My personal lawyer filed a writ and the bank was given orders to remove such unlawful freeze within 26 days.`,
  },
  {
    name: "Anonymous",
    role: "Undisclosed",
    image: { six },
    rating: 5,
    review: `I'm skeptical of landlords after having been a victim of their fraud twice. I'm so so happy with medences rental checkup.`,
  },
  {
    name: "Venkat Giri",
    role: "Business Owner",
    image: { user },
    rating: 5,
    review: `I approached medence after a long deadlock of my grandfather's property. Our lawyer saw it from a different lens altogether and gave us a way out.`,
  },
];
